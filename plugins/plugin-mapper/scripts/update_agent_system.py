...
Usage:
  python3 plugins/plugin-mapper/skills/plugin-mapper/scripts/update_agent_system.py
"""
...
PLUGIN_INSTALLER = ROOT / "plugins/plugin-mapper/skills/plugin-mapper/scripts/install_all_plugins.py"
