...
Usage:
    python3 plugins/plugin-mapper/skills/plugin-mapper/scripts/generate_readmes.py [--apply]
"""
...
PROJECT_ROOT = SCRIPT_DIR.parent.parent.parent  # repo-root/plugins/plugin-mapper/scripts/ → 3 levels up
